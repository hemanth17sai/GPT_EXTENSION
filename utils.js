import { setObserver, getToken, setSideBar, getQuestions } from "./chatState";
...
export function refreshSideBar(sideBar){
...
export function pushToSideBar(question,list){//function to push questions into sidebar
    // const list = document.getElementById("cgpt-q-list");
